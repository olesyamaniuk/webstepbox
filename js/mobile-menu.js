document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".i-g-navigation-list");
  const headerRef = document.querySelector(".i-g-header");
  const navigationRef = document.querySelector(".i-g-navigation");
  ...
  document.querySelectorAll(".i-g-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".i-g-toggle-button img");
